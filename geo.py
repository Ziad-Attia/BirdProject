...
data = pd.read_excel(path + 'Bird_Ranges_AGJ edits.xlsx')
...
geoNorth.to_csv(path + 'geoNorth.csv')
geoSouth.to_csv(path + 'geoSouth.csv')
addressesNorth.to_csv(path + 'addressesNorth.csv')
addressesSouth.to_csv(path + 'addressesSouth.csv')
